...
-(id)operatorName{
	...
	static void loadPrefs(){
		NSMutableDictionary *prefs = [[NSMutableDictionary alloc] initWithContentsOfFile:@"/var/mobile/Library/Preferences/com.pxcex.carrirartistmusic.plist"];

		if(prefs){
		//ACEnabled =[[prefs objectForKey:@"ACEnabled"] boolValue];
			ACServer_ACNAText = (prefs[@"ACNAText"] ? prefs[@"ACNAText"] : @"pxcex");
			ACServer_ArtistName = ACServer_ACNAText;
